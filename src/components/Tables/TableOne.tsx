...
import { Category, Manufacture, OrderItems, Product } from "@prisma/client";
          ...
          >
            <div className="flex items-center gap-3 p-2.5 xl:p-5">
              <div className="flex-shrink-0">
                <Image src={`${process.env.NEXT_PUBLIC_SUPABASE_PUBLIC_IMAGE}/${(product.images as string [])[0]}`} alt="Images" width={48} height={48} />
              </div>

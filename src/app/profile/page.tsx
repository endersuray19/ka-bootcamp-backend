...
export const metadata: Metadata = {
  title: "Next.js Profile | Admin WibuMERCH - Next.js Dashboard Template",
  description:
    "This is Next.js Profile page for Admin WibuMERCH - Next.js Tailwind CSS Admin Dashboard Template",
};

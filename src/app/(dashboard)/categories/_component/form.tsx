...
import { createCategory, updateCategory } from "@/app/auth/_components/actions";
...
export default function Form({category}:ActionFormProps){
  ...
  const handleSubmit = async (formData:FormData)=>{
    ...
    const result = category ? await updateCategory(formData,category.id.toString(),images): await createCategory(formData, images);
    if(!result.success){
      Swal.fire({
        icon:'error',
        title:'error',

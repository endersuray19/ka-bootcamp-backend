...
export default async function ManufacturesPage(){
    ...
    return(
        <div>
            <Breadcrumb pageName="Manufactures" />
            


    <div className="rounded-sm border border-stroke bg-white px-5 pb-2.5 pt-6 shadow-default dark:border-strokedark dark:bg-boxdark sm:px-7.5 xl:pb-1">
        <Link className="bg-primary text-white px-4 py-2 mb-3 inline-block rounded-md" href="/manufactures/create">
       Add Manufacture
        </Link>
              ...
              <tr key={key}>
                ...
                <td className="border-b border-[#eee] px-4 py-5 dark:border-strokedark">
                  <div className="flex items-center space-x-3.5">
                    <Link href={`/manufactures/${manufactures.id}`} className="hover:text-primary">
                    ...
                    <ActionForm manufactureId={manufactures.id.toString()}/>
